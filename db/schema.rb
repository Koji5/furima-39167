...
ActiveRecord::Schema.define(version: 2023_07_20_103638) do
  ...
  create_table "order_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["order_history_id"], name: "index_order_addresses_on_order_history_id"
  end
  ...
  add_foreign_key "order_addresses", "order_histories"
